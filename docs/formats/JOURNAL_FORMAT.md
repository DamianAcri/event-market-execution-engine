...
[READONLY_CAPTURE.md](../guides/READONLY_CAPTURE.md) and replay-plan schemas 2/3/4 (per-market/shared book/shared book plus public trades respectively). They retain
...
Shared-subscription controller replay (plan schemas 3 and 4) also recognizes
